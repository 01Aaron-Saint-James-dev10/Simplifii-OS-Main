...
export const PROFILES = {
  standard: {
    id: 'standard',
    name: 'Default, I will customise as I go',
  ...
  twice_exceptional: {
    ...
    name: 'I think in big ideas and need help with structure',
  ...
  autism_level_3: {
    id: 'autism_level_3',
    name: 'I work best with clear steps and no surprises',
  ...
  adhd: {
    id: 'adhd',
    name: 'I need momentum, short bursts, and low friction',
  ...
  dyslexic: {
    id: 'dyslexic',
    name: 'I process better with visual and audio support',
