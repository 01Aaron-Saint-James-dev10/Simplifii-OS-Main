            ...
            {isExpanded && (
              <div style={{ padding: '0 12px 12px', display: 'flex', flexDirection: 'column', gap: 8 }}>
                ...
                {criterion.selfAssessmentQuestion && (
                  <div style={{ padding: '6px 8px', background: 'rgba(245,158,11,0.06)', borderLeft: '2px solid #f59e0b', borderRadius: 2 }}>
                    <span style={{ fontFamily: FONT_SYSTEM, fontSize: 9, color: TEXT_FAINT, display: 'block', marginBottom: 2 }}>Ask yourself</span>
                    <span style={{ fontFamily: FONT_BODY, fontSize: 11, color: TEXT_PRIMARY, fontStyle: 'italic' }}>{criterion.selfAssessmentQuestion}</span>
                  </div>
                )}
              </div>
            )}
