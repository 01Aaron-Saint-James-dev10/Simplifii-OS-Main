 ...
 * AddWorkModal
 *
 * Universal "What are you working on?" entry point.
 * 6 work type cards. Selection drives AURA greeting and tool routing.
 */
...
export default function AddWorkModal({ onSelect, onClose }) {
  return createPortal(
    <div
    ...
    >
      ...
      >
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16 }}>
          <h2 style={{ fontFamily: FONT_BODY, fontSize: 18, fontWeight: 700, color: TEXT_PRIMARY, margin: 0 }}>
          ...
          {WORK_TYPES.map(w => (
            <button
              ...
              style={{
                ...
                alignItems: 'flex-start', outline: 'none',
              }}
            ...
            >
              ...
              <div>
                <span style={{ fontFamily: FONT_BODY, fontSize: 14, fontWeight: 600, color: TEXT_PRIMARY, display: 'block' }}>
                  {w.label}
                </span>
                <span style={{ fontFamily: FONT_SYSTEM, fontSize: 11, color: TEXT_MUTED, display: 'block', marginTop: 2, lineHeight: 1.4 }}>
                  {w.sub}
                </span>
              </div>
            </button>
