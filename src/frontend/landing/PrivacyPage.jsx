  ...
  return (
    <div style={s.root}>
      <div style={s.card}>
        ...
        <p style={s.body}>
          We are using Termly to generate compliant policies. Final version
        ...
        <p style={s.body}>
          In brief: your data stays yours. We do not sell individual learner
          data. Institutions receive only anonymised, aggregated statistics.
          Full details will be published here before public launch.
        </p>
      </div>
    </div>
  );
