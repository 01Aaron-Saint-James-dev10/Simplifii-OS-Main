...
const LEVELS = [
  ...
  { icon: 'M4.26 10.147a60.436 60.436 0 00-.491 6.347A48.627 48.627 0 0112 20.904a48.627 48.627 0 018.232-4.41 60.46 60.46 0 00-.491-6.347m-15.482 0a50.57 50.57 0 00-2.658-.813A59.905 59.905 0 0112 3.493a59.902 59.902 0 0110.399 5.84c-.896.248-1.783.52-2.658.814m-15.482 0A50.697 50.697 0 0112 13.489a50.702 50.702 0 017.74-3.342M6.75 15a.75.75 0 100-1.5.75.75 0 000 1.5zm0 0v-3.675A55.378 55.378 0 0112 8.443m-7.007 11.55A5.981 5.981 0 006.75 15.75v-1.5', title: 'University or college', body: 'Manage every subject in one place. Decode the brief. Build your space. Submit with confidence.' },
  { icon: 'M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m5.231 13.481L15 17.25m-4.5-15H5.625c-.621 0-1.125.504-1.125 1.125v16.5c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9zm3.75 11.625a2.625 2.625 0 11-5.25 0 2.625 2.625 0 015.25 0z', title: 'Postgraduate or research', body: 'Built for MRes, PhD, and research professionals. Phases, strands, chapters, citations, and methodology logs in one architecture.' },
  { icon: 'M11.42 15.17l-5.42 3.24V5.78l5.42 3.24m7.16-3.24v12.63l-5.42-3.24M3 5.78v12.63l5.42-3.24m0-6.15l5.42 3.24 5.42-3.24', title: 'TAFE, vocational or trade', body: 'Practical learning, plain-language scaffolds, and assessment support that works with how vocational training actually flows.' },
  ...
  { icon: 'M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L10.582 16.07a4.5 4.5 0 01-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 011.13-1.897l8.932-8.931zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0115.75 21H5.25A2.25 2.25 0 013 18.75V8.25A2.25 2.25 0 015.25 6H10', title: 'Teacher or educator', body: 'For staff writing research, grants, and teaching materials. Co-authoring, citation integrity, and version history that respects your voice.' },
